...
# Это выражение Python проверяет наличие файлов «audio.rpa» и «images.rpa»
...
init python:
    ...
    splash_message_default = __("Данная игра является неофициальной фанатской работой,\nкоторая никак не связана с Team Salvato.")
    ...
    splash_messages = [
        __("Пожалуйста, поддержите «Литературный клуб \"Тук-тук!\"»."),
        __("Моника следит за тем, что вы кодите.")
    ]
...
Чтобы выключить Режим летсплейщика, откройте Настройки и снимите флажок с соответствующего пункта."""),
    ...
    #         alpha 0.1
    #     with Dissolve(1.0)
    #     show expression Text(_("Теперь все будут счастливы."), style="sayori_text"):
    #         xalign 0.8
    #         yalign 0.5
    #         alpha 0.0
    #         600
