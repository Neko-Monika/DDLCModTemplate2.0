...
label start:
    ...
    # Именно здесь и вызываются ваши сценарии!
    ...
    call screen dialog("Похоже, вы пытаетесь начать новую игру в мод-шаблоне без сценария.\nЭто мод-шаблон, а не самостоятельная игра. Напишите сценарий для своей модификации, пропишите его вызов в файле «script.rpy» и повторите попытку.", ok_action=MainMenu(confirm=False))
    ...
    #     # или в папку Android/data/имя.пакета.абв/files.
    #     python:
