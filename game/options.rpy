## Это шаблон версии 3.0.2. Если у вас спросят версию использованного шаблона,
...
define config.name = "Мод-шаблон DDLC"
...
init python:
    ...
    if renpy.version_tuple == (6, 99, 12, 4, 2187):
        ...
        description="DDLC-совместимый мод на Ren'Py 7")
    ...
    build.classify("game/tl/**.rpymc", "scripts android") ## Базовый перевод интерфейса
    build.classify("game/tl/**.rpyc", "scripts android") ## Переводы на разные языки
    build.classify("game/mod_extras/**.rpyc", "scripts android") ## Дополнительные фишки
