...
init -1 python in achievements:
    ...
    # Синтаксис:
    #   name - Читабельное название достижения.
    #   description - Читабельное описание достижения.
    #   image - Путь к изображению достижения или тег оного.
    #   locked_desc - Читабельное описание неоткрытого достижения.
    #   show_desc_while_locked - Флаг, который определяет, какое из описаний достижения
...
##
## Синтаксис:
## al.image - Путь или тег изображения достижения.
## al.locked - Изображение неполученного достижения.
## al.persistent - Название внутриигровой переменной для проверки факта получения
##                 достижения.
## al.maxCount - Число, которое необходимо набрать для получения
##               достижения.
## gl.description - Описание достижения.
screen achievements():
...
##
## Синтаксис:
## reward.image - Путь или тег изображения достижения.
## reward.name - Читабельное название достижения.
## 
