...
##
## Синтаксис:
## gl.image - Путь к изображению или тег оного (напр. sayori 1a).
##
## gl.small_size - Путь к уменьшенной версии изображения или тег оной.
##
## gl.name - Читабельное название изображения в Галерее.
##
## gl.sprite - Флаг, который определяет, является ли это изображение спрайтом
##             персонажа.
## gl.unlocked - Флаг, который определяет, должно ли добавляться это изображение
